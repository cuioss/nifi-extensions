...
The MultiIssuerJWTTokenAuthenticator is compatible with Apache NiFi and leverages the OAuth-Sheriff library for token validation.
...
The processor is designed for Apache NiFi 2.x and takes advantage of its improved:
