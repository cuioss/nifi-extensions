...
The MultiIssuerJWTTokenAuthenticator is compatible with NiFi 2.6.0 and leverages the OAuth-Sheriff library for token validation.
...
The processor validates JWT tokens using the OAuth-Sheriff library with:
...
The processor fully leverages the OAuth-Sheriff library's capabilities:
