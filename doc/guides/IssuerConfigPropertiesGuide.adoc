...
. In the processor configuration dialog, look for the "Issuer Configuration" tab (it should appear alongside the standard "Settings", "Scheduling", and "Properties" tabs)
. If the tab is visible, click on it to access the issuer configuration interface
