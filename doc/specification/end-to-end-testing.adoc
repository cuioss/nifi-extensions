...
2. Verify endpoint configuration tab content (Global Settings, Management Endpoints, API Routes)
...
6. Verify metrics tab content (Token Validation, HTTP Security, Gateway Events sections)
7. Verify help tab content
