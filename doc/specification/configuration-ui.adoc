...
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/config/IssuerPropertyDescriptorFactory.java[IssuerPropertyDescriptorFactory] -- Dynamic property descriptor creation for issuers
...
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/JWTPropertyKeys.java[JWTPropertyKeys] -- Property key constants for issuer configuration
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/JWTTranslationKeys.java[JWTTranslationKeys] -- Translation key constants for UI labels

=== Verification
* link:../../nifi-cuioss-processors/src/test/java/de/cuioss/nifi/processors/auth/config/IssuerPropertyDescriptorFactoryTest.java[IssuerPropertyDescriptorFactoryTest]
...
All UI elements use internationalization through NiFi's I18nResolver API. See link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/config/IssuerPropertyDescriptorFactory.java[IssuerPropertyDescriptorFactory] for how translated property descriptors are created using link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/JWTTranslationKeys.java[JWTTranslationKeys].
