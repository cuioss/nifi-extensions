...
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/JWTProcessorConstants.java[JWTProcessorConstants] -- Property definitions, relationships, and processor constants
...
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/MultiIssuerJWTTokenAuthenticator.java[MultiIssuerJWTTokenAuthenticator] -- Main processor with configuration handling
...
The processor supports multiple issuers through NiFi dynamic properties. In the NiFi UI, issuer properties use the prefix `issuer.<N>.<property>`:
...
# Issuer configuration (static config file prefix)
