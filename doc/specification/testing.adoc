...
void testProcessWithValidToken() {
    ...
    // Configure a test JWKS endpoint using cui-test-mockwebserver-junit5
    // (CUI test utilities are used instead of Mockito — see project conventions)
...
void testHighThroughputPerformance() {
    ...
    LOGGER.info("Throughput: %s tokens/second", throughputPerSecond);

    // Assert minimum throughput requirement
    assertTrue(throughputPerSecond > 1000, "Throughput should exceed 1000 tokens/second");
}
----
