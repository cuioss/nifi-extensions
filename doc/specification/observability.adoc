...
The processor collects metrics using the SecurityEventCounter provided by the oauth-sheriff-core library:
...
A dedicated class bridges the oauth-sheriff-core SecurityEventCounter and NiFi's metrics system:
