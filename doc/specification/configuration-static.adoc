...
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/config/ConfigurationManager.java[ConfigurationManager] -- Static config loading from files and environment variables
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/config/IssuerConfigurationParser.java[IssuerConfigurationParser] -- Parsing issuer configurations from properties and YAML

=== Verification
* link:../../nifi-cuioss-processors/src/test/java/de/cuioss/nifi/processors/auth/config/ConfigurationManagerTest.java[ConfigurationManagerTest]
* link:../../nifi-cuioss-processors/src/test/java/de/cuioss/nifi/processors/auth/config/IssuerConfigurationParserTest.java[IssuerConfigurationParserTest]
...
See the configuration refresh logic in link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/config/ConfigurationManager.java[ConfigurationManager].
...
The processor implements robust error handling for configuration loading. See link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/config/ConfigurationManager.java[ConfigurationManager] for error handling implementation.
