...
For more details on the OAuth-Sheriff library, see the https://github.com/cuioss/oauth-sheriff[oauth-sheriff] project documentation.
...
For more details on security best practices, see link:security-architecture.adoc[Security Architecture].
