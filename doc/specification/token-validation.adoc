...
For more details on the oauth-sheriff-core library, see link:../library/oauth-sheriff-core.adoc[Library Documentation].

=== How the Processor Uses oauth-sheriff-core

In NiFi 2.4.0, the processor initializes and uses the oauth-sheriff-core library as follows:
...
<dependency>
    ...
    <version>${version.oauth-sheriff-core}</version>
</dependency>
----
...
* link:../library/oauth-sheriff-core.adoc[Library Documentation]
