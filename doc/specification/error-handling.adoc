...
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/util/ErrorContext.java[ErrorContext] -- Structured error context with component, operation, and error code
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/util/ProcessingError.java[ProcessingError] -- Value object for flow file processing failures
...
See link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/util/ErrorContext.java[ErrorContext] for the builder API and usage patterns.
...
The processor leverages the oauth-sheriff-core library's error reporting capabilities, which are mapped to NiFi's error handling mechanisms. See link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/MultiIssuerJWTTokenAuthenticator.java[MultiIssuerJWTTokenAuthenticator] for the validation error handling and flow file attribute mapping, and link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/AuthLogMessages.java[AuthLogMessages] for the standardized error message definitions.

=== Security Event Monitoring

The processor implements security event monitoring as described in xref:token-validation.adoc#_security_event_monitoring[Security Event Monitoring].
