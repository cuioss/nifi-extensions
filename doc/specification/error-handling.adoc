...
Error processing flow file [ErrorCode=PROCESSING_ERROR, Component=MultiIssuerJWTTokenAuthenticator, Operation=onTrigger, flowFileUuid=abc123] Caused by: JWTValidationException: Token signature is invalid
