...
* link:../../nifi-cuioss-ui/src/test/java/de/cuioss/nifi/ui/servlets/MetricsServletTest.java[MetricsServletTest] -- Metrics endpoint unit tests
...
* link:../../nifi-cuioss-ui/src/test/java/de/cuioss/nifi/ui/servlets/integration/BackendEndpointsIntegrationTest.java[BackendEndpointsIntegrationTest] -- REST Assured integration tests for all endpoints
* link:../../e-2-e-playwright/tests/04-verify-token-verification-tab.spec.js[E2E Token Verification Tab Test]
