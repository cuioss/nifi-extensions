...
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/i18n/NiFiI18nResolver.java[NiFiI18nResolver] -- NiFi-specific resource bundle resolution
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/i18n/I18nResolver.java[I18nResolver] -- Interface for internationalized message resolution
* link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/JWTTranslationKeys.java[JWTTranslationKeys] -- Centralized translation key constants

=== Verification
* link:../../nifi-cuioss-processors/src/test/java/de/cuioss/nifi/processors/auth/i18n/NiFiI18nResolverTest.java[NiFiI18nResolverTest]
...
The processor integrates with NiFi's built-in internationalization framework using the link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/i18n/I18nResolver.java[I18nResolver] API, implemented by link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/i18n/NiFiI18nResolver.java[NiFiI18nResolver] for resource bundle loading and message resolution.
...
For messages requiring parameter substitution, the processor uses the standard Java `MessageFormat` approach via link:../../nifi-cuioss-processors/src/main/java/de/cuioss/nifi/processors/auth/i18n/NiFiI18nResolver.java[NiFiI18nResolver].
