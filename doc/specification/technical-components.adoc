...
For detailed information about attribute handling and token validation output, see the https://github.com/cuioss/oauth-sheriff[OAuth-Sheriff] documentation.
...
For detailed implementation of token validation, see the https://github.com/cuioss/oauth-sheriff[OAuth-Sheriff] documentation.
...
For more configuration details, see the https://github.com/cuioss/oauth-sheriff[OAuth-Sheriff] documentation.
...
For detailed implementation examples, see link:../guides/QuickStart.adoc[Quick Start Guide].
...
For complete details on TokenValidator lifecycle management, including thread safety and resource management, see the https://github.com/cuioss/oauth-sheriff[OAuth-Sheriff] documentation.
...
Security is paramount in JWT token validation. For information about security implementation, best practices, and threat mitigations, see link:security-architecture.adoc[Security Architecture].
...
* link:configuration-ui.adoc#_internationalization[Internationalization]
