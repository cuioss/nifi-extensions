...
|`Request rejected: POTENTIAL_ATTACK_DETECTED`
...
|`Insufficient roles: missing [admin]`
...
|`Method POST is not allowed on route 'health'. Allowed methods: [GET]`
...
|`Request body of 2097152 bytes exceeds maximum allowed size of 1048576 bytes`
