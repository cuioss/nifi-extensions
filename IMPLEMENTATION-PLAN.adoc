...
* [ ] Production implementation using HandleHTTPRequest/Response (see doc/jwt-api-endpoints-implementation.md)

NOTE: The E2E test `07-verify-token-verification-api.spec.js` is currently skipped as it requires REST endpoints that don't exist in standard NiFi. Once the endpoints are implemented following the guide in `doc/jwt-api-endpoints-implementation.md`, remove the skip and enable the test.
