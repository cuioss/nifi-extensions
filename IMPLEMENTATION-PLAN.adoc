...
==== Proposed Solutions
* *Option 1*: Create MockProcessContext that properly returns dynamic properties
...
* *Tasks*:
  - [ ] Analyze TestRunner dynamic property handling
  - [ ] Implement chosen solution for test framework
  - [ ] Update all failing tests to use new approach
  - [ ] Ensure all unit tests pass
  - [ ] Document testing approach for dynamic properties
* *Dependencies*: None
