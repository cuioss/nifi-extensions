...
=== Phase 2.5: E2E Test Enablement (P1)

==== Enable and Extend E2E Tests
* [ ] Fix E2E test navigation pattern to access custom UI through processor configuration
* [ ] Update test 02-verify-jwt-authenticator-customizer.spec.js to navigate via processor
* [ ] Update test 03-verify-jwks-validation-button.spec.js to navigate via processor
* [ ] Update test 04-verify-token-verification-tab.spec.js to navigate via processor
* [ ] Update test 05-verify-metrics-tab.spec.js to navigate via processor
* [ ] Update test 06-verify-help-tab.spec.js to navigate via processor
* [ ] Enable test 07-verify-token-verification-api.spec.js (remove skip)
* [ ] Update test 08-verify-jwks-validation-complete.spec.js to navigate via processor
* [ ] Create processor creation utility for E2E tests
* [ ] Add authentication handling for custom UI access
* [ ] Ensure all UI interactions are covered by E2E tests
* [ ] Add E2E tests for error scenarios
* [ ] Add E2E tests for edge cases

NOTE: E2E tests currently fail because they try to access the custom UI directly at `/nifi-cuioss-ui/`. They need to navigate through NiFi canvas -> create processor -> open configuration -> access custom UI.
