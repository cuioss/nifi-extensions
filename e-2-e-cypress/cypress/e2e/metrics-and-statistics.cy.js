...
describe('Processor Metrics and Statistics Tests', () => {
    ...
    beforeEach(() => {
        ...
        cy.addProcessor('MultiIssuerJWTTokenAuthenticator', { x: 100, y: 100 })
            .then((id) => {
                processorId = id;
            });
    });
    ...
    describe('Metrics Display Verification', () => {
        ...
        it('should show detailed metrics in processor details pane', () => {
            ...
            cy.get('[data-testid="processor-details-pane"]', { timeout: 10000 })
                .should('be.visible');
        ...
        it('should display metrics in configuration dialog metrics tab', () => {
            ...
            cy.get('[data-testid="config-dialog-tabs"]')
                .find('[data-tab="metrics"]')
                .click();
            ...
            cy.get('[data-testid="metrics-percentages"]')
                .should('contain.text', '%');
    ...
    describe('Metrics Functionality Tests', () => {
        ...
        it('should reset metrics when reset button is clicked', () => {
            ...
            cy.get('[data-testid="confirm-reset-dialog"]')
                .should('be.visible');
    ...
    describe('Performance Metrics Tests', () => {
        ...
        it('should display issuer-specific metrics', () => {
            ...
            cy.get('[data-testid="issuer-a-count"]')
                .should('contain.text', '1');

            cy.get('[data-testid="issuer-b-count"]')
