...
**Expected Results**:
- [x] Docker containers start successfully (NiFi + Keycloak).
- [x] Services become ready quickly.
- [x] No Cypress tests executed.
...
**Expected Results**:
- [x] Single test executes successfully.
...
**Expected Results**:
- [x] Navigation test executes successfully.
...
**Expected Results**:
- [x] Elements test executes successfully.
- [x] Execution time: < 10 seconds.
...
**Expected Results**:
- [x] Interaction test executes successfully.
