...
* Playwright 1.58.1 for E2E testing

All frontend configuration is centralized in the root POM properties.

[IMPORTANT]
====
All contributors and AI tools (including GitHub Copilot, Claude, and others) **must follow the AI Development Guidelines in** link:agents.md[agents.md].

These guidelines are mandatory for all code, documentation, and configuration changes. See the file for project architecture, development environment, testing, code style, and process standards.
====
