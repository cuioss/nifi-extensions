...
*UI Sources*: https://github.com/apache/nifi/tree/main/nifi-frontend
...
Request-Token: [CSRF token from __Secure-Request-Token cookie]
Body: username=testUser&password=drowssap

→ HTTP 2xx (e.g. 201 Created)
...
From NiFi source (`apps/nifi/src/app/pages/flow-designer/ui/canvas/canvas.component.html`, simplified):
