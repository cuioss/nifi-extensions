...
See `AGENTS.md` "Docker E2E Deployment" section or the `/deploy` skill for the full deployment runbook.
...
[source,bash]
----
# 1. Pre-commit auto-fix (rewrites files; review and commit what it changed)
