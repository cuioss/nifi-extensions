...
[NOTE]
====
The JWT UI analysis is injected directly into the browser console and captured within the unified log entries. Look for "JWT UI ANALYSIS SUMMARY" markers in the log.
====
