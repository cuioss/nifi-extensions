...
* `test-results/` - Execution artifacts (browser.log, test-run.log, screenshots, video, trace.zip)
* `playwright-report/` - HTML report

[source,bash]
----
# Find errors in specific test phase
grep -n "ERROR" target/results-functional-tests/test-results/*/browser.log
