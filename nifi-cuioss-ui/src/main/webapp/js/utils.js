...
export const TRANSLATIONS = {
    en: {
        ...
        'route.form.section.basic': 'Basic',
        ...
        'route.form.tracking.attachments': 'Attachments',
        'route.form.attachments.min': 'Min Attachments',
        'route.form.attachments.max': 'Max Attachments',
        'route.form.attachments.timeout': 'Attachment Timeout',
        ...
        'route.validate.tracking.methods': 'Tracking requires at least one body method (POST, PUT, or PATCH).',
        'route.validate.attachments.min.negative': 'Min attachments must be >= 0.',
        'route.validate.attachments.max.negative': 'Max attachments must be >= 0.',
        'route.validate.attachments.min.exceeds.max': 'Min attachments must not exceed max.',
        'route.validate.attachments.max.exceeds.limit': 'Max attachments must not exceed {0}.',
        'route.validate.attachments.timeout.invalid': 'Attachment timeout must be a positive number.',
        ...
        'route.save.success.banner': 'Route saved and persisted to processor configuration successfully.',
        ...
        'route.management.heading': 'Standard Endpoints',
        ...
        'contexthelp.route.tracking': 'Controls async request tracking for this route. None: no tracking. Simple: POST/PUT/PATCH return 202 with traceId and a status link. Attachments: like Simple, but also includes an attachments link for uploading related documents. Configure min/max bounds for the number of attachments per request. Requires a Distributed Map Cache Client on the processor.',
        'contexthelp.route.attachments.timeout': 'How long the NiFi Wait processor holds the parent request FlowFile while waiting for attachments. After this timeout, the parent is released for downstream processing and the attachment window closes (further uploads return 409). Uses NiFi time duration format (e.g. "30 sec", "1 min").',
    ...
    de: {
        ...
        'route.form.schema.file.placeholder': './conf/schemas/my-schema.json',
        'route.form.schema.inline.placeholder': '{"type":"object","properties":{}}',
        'route.form.section.basic': 'Basis',
        ...
        'route.form.tracking.attachments': 'Anh\u00e4nge',
        'route.form.attachments.min': 'Min. Anh\u00e4nge',
        'route.form.attachments.max': 'Max. Anh\u00e4nge',
        'route.form.attachments.timeout': 'Anhang-Timeout',
        'route.table.tracking': 'Tracking',
        ...
        'route.validate.tracking.methods': 'Tracking erfordert mindestens eine Body-Methode (POST, PUT oder PATCH).',
        'route.validate.attachments.min.negative': 'Min. Anh\u00e4nge muss >= 0 sein.',
        'route.validate.attachments.max.negative': 'Max. Anh\u00e4nge muss >= 0 sein.',
        'route.validate.attachments.min.exceeds.max': 'Min. Anh\u00e4nge darf Max nicht \u00fcberschreiten.',
        'route.validate.attachments.max.exceeds.limit': 'Max. Anh\u00e4nge darf {0} nicht \u00fcberschreiten.',
        'route.validate.attachments.timeout.invalid': 'Anhang-Timeout muss eine positive Zahl sein.',
        ...
        'route.save.success.banner': 'Route erfolgreich gespeichert und in der Prozessor-Konfiguration persistiert.',
        ...
        // -- management endpoints --
        'route.management.heading': 'Standard-Endpunkte',
        ...
        'contexthelp.route.tracking': 'Steuert asynchrones Request Tracking f\u00fcr diese Route. Keine: kein Tracking. Einfach: POST/PUT/PATCH antworten mit 202, traceId und Status-Link. Anh\u00e4nge: wie Einfach, enth\u00e4lt zus\u00e4tzlich einen Attachments-Link zum Hochladen zugeh\u00f6riger Dokumente. Min/Max-Grenzen f\u00fcr die Anzahl der Anh\u00e4nge pro Request konfigurierbar. Erfordert einen Distributed Map Cache Client am Prozessor.',
        'contexthelp.route.attachments.timeout': 'Wie lange der NiFi Wait-Prozessor das \u00fcbergeordnete Request-FlowFile h\u00e4lt, w\u00e4hrend auf Anh\u00e4nge gewartet wird. Nach diesem Timeout wird der Parent f\u00fcr die Downstream-Verarbeitung freigegeben und das Anhang-Fenster geschlossen (weitere Uploads geben 409 zur\u00fcck). Verwendet das NiFi Time Duration Format (z.B. "30 sec", "1 min").',
